...
public interface LinkShortener {
     ...
     *
     * @param page
     *            {@link Page} to create a short URL for
     * @return Short URL, or {@code null} if none could be generated (e.g. there was no
     *         shortener service configured)
     */
    String shorten(Page page);
