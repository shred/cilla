...
/**
 * Converts a String to a {@link TextSection}.
 *
 * @author Richard "Shred" Körber
 */
public class StringToTextSection implements Converter<String, TextSection> {
    ...
    public TextSection convert(String string) {
        try {
            ...
            LoggerFactory.getLogger(getClass()).debug("no valid text section id '{}'", string, ex);
            return null;
        }
    }
